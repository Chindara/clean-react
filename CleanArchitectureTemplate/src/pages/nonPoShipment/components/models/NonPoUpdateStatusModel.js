...
import { NONPOSHIPMENT_STATUS } from 'constants/Common';
				...
				<React.Fragment>
					...
					<DialogContent sx={{ mt: 2, my: 1 }}>
						<Stack direction='column' spacing={2} alignItems='center' justifyContent='center'>
							<Button
								size='large'
								onClick={() => handleStatusChange(NONPOSHIPMENT_STATUS.UnderClearance)}
								color='warning'
								variant='contained'
								disabled={statusloading || status === NONPOSHIPMENT_STATUS.UnderClearance || status === NONPOSHIPMENT_STATUS.Cleared}
								autoFocus
								sx={{ width: '80%' }}
							>
								Under Clearance
