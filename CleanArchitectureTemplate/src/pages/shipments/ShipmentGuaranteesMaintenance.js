...
const ShipmentGuaranteesMaintenance = () => {
	...
	return (
		<>
			...
			<MainCard>
				<GuaranteeList handleGuaranteeForm={handleGuaranteeForm} shipmentId={shipment?.id} />
			</MainCard>
...
export default ShipmentGuaranteesMaintenance;
