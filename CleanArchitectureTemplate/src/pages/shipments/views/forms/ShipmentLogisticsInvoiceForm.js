...
export default function LogisticsInvoiceForm({ isFetching }) {
	...
	const { logisticsInvoice, setLogisticsInvoice, error, setError, mode } = useShipment();
			...
			{isFetching ? (
				...
				<MainCard>
					<Grid container spacing={1} justifyContent='flex-start'>
						...
						<Grid item xs={12}>
							<Stack spacing={0.5}>
								<InputLabel required>Invoice Received Date</InputLabel>
								<LocalizationProvider dateAdapter={AdapterDateFns}>
									<DatePicker
										inputFormat='dd/MM/yyyy'
						...
						<Grid item xs={12}>
							<Stack spacing={0.5}>
								<InputLabel required>Invoice Reference</InputLabel>
								<TextField
									placeholder='Enter the Invoice Reference'
									fullWidth
									size={CONTROL_SIZE}
