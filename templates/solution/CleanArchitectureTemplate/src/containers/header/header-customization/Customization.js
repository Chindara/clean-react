...
// assets
import { LayoutOutlined, HighlightOutlined, BorderInnerOutlined, BgColorsOutlined, SettingOutlined, CloseCircleOutlined, FontColorsOutlined } from '@ant-design/icons';
								...
								<Accordion sx={{ borderTop: 'none' }}>
									<AccordionSummary aria-controls='panel1d-content' id='panel1d-header'>
										<Stack direction='row' spacing={1.5} alignItems='center'>
											<IconButton disableRipple color='primary' sx={{ bgcolor: 'primary.lighter' }} onClick={handleToggle} aria-label='settings toggler'>
												<LayoutOutlined />
											</IconButton>
											<Stack>
