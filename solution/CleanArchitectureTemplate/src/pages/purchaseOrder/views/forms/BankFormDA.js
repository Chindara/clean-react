...
export default function BankFormDA() {
	...
	const handleOnChange = (event) => {
		...
		if (name === 'endorsedAmount') {
			...
			setPurchaseOrderBank((prevState) => ({ ...prevState, DA: { ...prevState.DA, balanceAmount: balanceAmount } }));
		}

		setPurchaseOrderBank((prevState) => ({ ...prevState, DA: { ...prevState.DA, [name]: value } }));
	};
	...
	const handleDatePickerChange = (property, value) => {
		...
		setPurchaseOrderBank((prevState) => ({ ...prevState, DA: { ...prevState.DA, [property]: value } }));
	};
	...
	const handleAutoCompleteChange = (value) => {
		...
		setPurchaseOrderBank((prevState) => ({ ...prevState, DA: { ...prevState.DA, bank: value } }));
				...
				<Grid item xs={12} sm={6}>
					<Stack spacing={0.5}>
						...
						<Autocomplete
							...
							value={bankOptions.find((option) => option?.value === purchaseOrderBank.DA.bank?.value) || null}
				...
				<Grid item xs={12} sm={6}>
					<Stack spacing={0.5}>
						...
						<TextField
							...
							fullWidth
							size={CONTROL_SIZE}
							value={purchaseOrderBank.DA.endorsedAmount || ''}
					...
					<Stack spacing={0.5}>
						...
						<LocalizationProvider dateAdapter={AdapterDateFns}>
							<DatePicker
								...
								value={purchaseOrderBank.DA.submittedToBank}
				...
				<Grid item xs={12} sm={6}>
					<Stack spacing={0.5}>
						...
						<LocalizationProvider dateAdapter={AdapterDateFns}>
							<DatePicker
								inputFormat='dd/MM/yyyy'
								value={purchaseOrderBank.DA.endorsementReceivedDate}
				...
				<Grid item xs={12} sm={6}>
					<Stack spacing={0.5}>
						...
						<TextField
							...
							fullWidth
							size={CONTROL_SIZE}
							value={purchaseOrderBank.DA.bankEndorsementReference || ''}
							onChange={handleOnChange}
						/>
					</Stack>
				</Grid>
				<Grid item xs={12} sm={6}>
					<Stack spacing={0.5}>
						...
						<TextField
							...
							fullWidth
							size={CONTROL_SIZE}
							value={purchaseOrderBank.DA.balanceAmount || ''}
							onChange={handleOnChange}
							disabled
						/>
					</Stack>
				...
				<Grid item xs={12} sm={6}>
					<Stack spacing={0.5}>
						...
						<LocalizationProvider dateAdapter={AdapterDateFns}>
							<DatePicker
								inputFormat='dd/MM/yyyy'
								value={purchaseOrderBank.DA.originalDocReceivedDate}
				...
				<Grid item xs={12} sm={6}>
					<Stack spacing={0.5}>
						...
						<TextField
							...
							fullWidth
							size={CONTROL_SIZE}
							value={purchaseOrderBank.DA.originalDocReceivedReference || ''}
							onChange={handleOnChange}
						/>
					</Stack>
				</Grid>
				<Grid item xs={12} sm={6}>
					<Stack spacing={0.5}>
						...
						<LocalizationProvider dateAdapter={AdapterDateFns}>
							<DatePicker
								inputFormat='dd/MM/yyyy'
								value={purchaseOrderBank.DA.copyDocsSubmittedToFinance}
				...
				<Grid item xs={12} sm={6}>
					<Stack spacing={0.5}>
						...
						<TextField
							...
							fullWidth
							size={CONTROL_SIZE}
							value={purchaseOrderBank.DA.remark || ''}
							onChange={handleOnChange}
						/>
					</Stack>
				</Grid>
