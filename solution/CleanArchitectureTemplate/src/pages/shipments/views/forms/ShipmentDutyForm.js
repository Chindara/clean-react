...
export default function DutyForm({ isFetching }) {
	...
	const { duty, setDuty, error, setError, mode } = useShipment();
						...
						<Grid container spacing={1} justifyContent='flex-start'>
							...
							<Grid item xs={12}>
								<Stack spacing={0.5}>
									...
									<TextField
										...
										helperText={
											(error.includes('validate-additionalCharge') && VALIDATION_ERROR_SHIPMENT_DUTY.cidRequired) ||
											(error.includes('validate-additionalCharge-format') && VALIDATION_ERROR_SHIPMENT_DUTY.additionalChargeValidation)
										}
										onChange={(e) => {
											handleDuty(e);
							...
							<Grid item xs={12}>
								<Stack spacing={0.5}>
									...
									<TextField
										placeholder='Enter Total Duty Update'
										fullWidth
										size={CONTROL_SIZE}
							...
							<Grid item xs={12}>
								...
								<Stack spacing={0.5}>
									...
									<TextField
										...
										helperText={error.includes('validate-remarks') && VALIDATION_ERROR_SHIPMENT_DUTY.remarksRequired}
										disabled={mode === OPERATION_MODE.View}
									/>
								</Stack>
							</Grid>
